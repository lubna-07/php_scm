        ...
        else
{
    $av_qty=0;
    $exist_qty=0;
    $exist_qty=check_the_qty($company_name,$product_name,$packing_size,$link);
    $exist_qty=$exist_qty+$qty;
    $av_qty=check_qty($company_name,$product_name,$packing_size,$link);
    // echo $av_qty;
    if($av_qty>=$exist_qty)
    {
        $check_product_no_session = check_product_no_session($company_name,$product_name,$packing_size);
